...
CREATE INDEX idx_ticket_ultima_actualizare ON TickLy.ticket(data_ultima_actualizare);
...
CREATE INDEX idx_ticket_history_ticket ON TickLy.ticket_history(ticket_id);
